...
inherits(IncomingMessage, readable.Readable);
...
inherits(ClientRequest, readable.Writable);
...
ClientRequest.prototype.end = function (data, encoding, cb) {
	...
	readable.Writable.prototype.end.call(self, data, encoding, cb);
};
...
var builtinStatusCodes = require$$0$1.STATUS_CODES;
...
http.STATUS_CODES = builtinStatusCodes;
